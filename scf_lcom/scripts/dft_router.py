...
#     # Special case where child is a xc_func
...
#     # Master should be built, now set c_alpha to 1.0 (c_os and c_ss already calcualted)
...
def build_lcom_from_dict(func_dict: dict, npoints, deriv, restricted):
    return LCOMSuperFunctionalBuilder(func_dict, npoints, deriv, restricted).get_psi_func_dispersion()        
